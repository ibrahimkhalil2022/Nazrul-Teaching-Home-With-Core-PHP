...
<html>
    ...
    <body style="background-color: #f1f1f1"> 
        ...
        <div class="main_body"> 
            ...
            <form action="employeeSalaryGenerate.php" method="POST">
                <div style="margin:auto; width: 98%;  height: auto;">
                    ...
                    <table style="width:100%; text-align: center;">
                        <tr><th style="width:5%;">Emp. ID</th>
                            ...
                            <th style="width:10%;">Add New Reduction</th> 
                        </tr>
                    ...
                    ?> 
                        ...
                        <tr>
                            ...
                            <td><?php echo $ts; ?> </td> 
                            <td>
							<a href="employeeSalaryReduction.php?id=<?php echo $id; ?>" >
								<button type="button" style="background:red;color: white; padding:5px 20px 5px 20px;">Add</button>
							</a> 
                            </td>
                ...
                <input type="submit" name="reduction" value="Salary Generate" style="margin-left: 880px; margin-top: 30px;">
            </form>
