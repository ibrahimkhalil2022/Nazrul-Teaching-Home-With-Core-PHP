...
<html>
    <head>
        ...
        <title>dueAdmissionFee.jsp</title>
    </head>
        ...
        <div class="main_body"> 
            ...
            <div class="admin">
                <div>
                    ...
                    <form action="dueAdmissionFeeShow.php" method="get">
                        <fieldset>
                            ...
                            <div style="padding: 20px 5px 0px 5px;">
                                <div class="login">
                                    <input type="submit" value="Submit" style="background: green; width: 210px; font-size: 15px;"> 
                                </div>
