    ...
    <body style="background-color: #f1f1f1">
        ...
        <div class="main_body">
            ...
            <div style="margin-top: 30px; margin-left: auto; margin-right: auto; width: 90%; min-height: 400px;">
                <div style="text-align:center; font-size: 25px; padding: 5px; margin-bottom: 20px;">Visitor's By Course</div>
				...
				if(isset($_POST["submit"]))
				{
						...
						$stmt = $conn->query("SELECT *FROM visitorsinfo where preferredCourse = '$preferredCourse'");
						...
						{ 
							...
							<tr>
								...
								<th><div style="width:60px; font-size: 15px; padding: 3px; margin: auto; color: red;">
										<a href="visitorsCallCount.php?id=<?php echo $id; ?>" >Done</a></div></th>
								<th><div style="width:60px; font-size: 15px; padding: 3px; margin: auto; color: red;">
										<a href="visitorsDeletetemp.php?id=<?php echo $id; ?>" >Delete</a></div></th> 
							</tr> 
							<?php
                        }
					}
