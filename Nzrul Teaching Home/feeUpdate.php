                   ...
                   <table style="text-align:center;">
					...
					try 
					{
                        ...
                        <tr>
							...
							<td><a href="feeUpdateShow.php?id=<?php echo $id; ?>" >
								<button type="button" style="background:red;color: white; padding:5px 20px 5px 20px;">Update</button>
								</a>
							</td>  
                        </tr>
                        <?php 
