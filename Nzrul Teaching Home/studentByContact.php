        ...
        <div class="main_body"> 
            ...
            <div class="admin">
                <div>
                    ...
                    <form action="studenByContactView.php" method="POST">
                        <fieldset>
                            <div style="padding: 5px;">
                                ...
                                <div style="display: inline-table; width: 30%;">
                                    <div>
                                        <input type="text" name="contact" placeholder="Enter Student Contact" style="padding: 5px;font-size: 15px;" required>
                                    </div>
                                </div>
                            </div>
                            <div style="padding: 5px;">
