...
<?php
	...
	$costBranch=$_POST["costBranch"];
	
	$_SESSION["costTitle"] = $costTitle;
	$_SESSION["costBranch"] = $costBranch;
	}else{
        ...
        <div class="main_body"> 
            ...
            <div style="margin:auto; width: 98%; min-height: 300px;">
                <div style="font-size:24px; text-align: center; font-weight: bold; margin-bottom: 10px;">
                    Cost Details of <?php echo $costTitle; ?> at <?php echo $branch; ?> Branch
                </div>
			...
			$conn = null;
                ...
                <div style="height: 40px;">
                    <form action="costSearchByItemBranchPrint.php">
