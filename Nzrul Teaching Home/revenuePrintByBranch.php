    ...
    <body style="background-color: darkorchid;">
		...
		<div>
            ...
            <div style="display: inline-table;">
                <form action="revenueByBranchView.php"><input type="submit" value="Go Back"></form>
            </div>
        </div>
...
<!--                    <div class="dateSerial" style="text-align:left;">MR No.&nbsp;<b><?php echo $mrpNo?></b></div>-->
                    <div class="dateSerial" style="margin-left:280px; border-bottom: 1px solid black; width:200px;">
                        <font style="font-weight: bolder; font-size: 20px;">Revenue of <?php echo $revenueBranch; ?></font><br>
                    </div>
                    <div class="dateSerial" style="float:right;">Date:&nbsp;&nbsp;<b><?php echo $date?></b></div>
                </div>
                <div style="text-align: center;">
                    <b style="margin-left:50px;">From:&nbsp;&nbsp;</b><?php echo $fromDate;?>&nbsp;&nbsp;<b>to&nbsp;&nbsp;</b> <?php echo $toDate;?>
                </div>
