        ...
        <div class="main_body"> 
            ...
            <div style="margin:auto; width: 98%; min-height: 300px;">
                <div style="font-size:30px; text-align: center;font-weight: bold; margin-bottom: 10px;">
                    <u>Due student information (From <?php echo $fromDate; ?> To <?php echo $fromDate; ?>) </u></div>
                <table style="width:100%; text-align: center;">
					...
					try 
					{
						...
						$stmt = $conn->query("SELECT *FROM `duetable` WHERE paymentDate BETWEEN '$fromDate' AND 'toDate'");
		    ...
		    <form action="feeDueStudentPrint.php">
