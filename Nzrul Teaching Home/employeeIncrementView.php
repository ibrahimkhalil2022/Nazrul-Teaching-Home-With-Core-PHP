...
<html>
    ...
    <body style="background-color: #f1f1f1">
        ...
        <div class="main_body"> 
            ...
            <div style="margin:auto; width: 88%; min-height: 300px;">
                ...
                <table style="width:100%; text-align: center;">
                    <tr>
						...
						<th>Basic Salary</th>
                        <th>Increment</th>
                        <th style="width:500px;">View Increment</th> 
                    </tr>
                    ...
                    <?php  
						...
						try {
							...
							<tr>
								...
								<td style="width:500px;"><a href="employeeIncrementViewInfo.php?empId=<?php echo $id; ?>" >View</a></td> 
							</tr>
                    <?php 
                        }
					}
