        ...
        <div class="main_body">
            ...
            <div class="admin">
                <div>
                    ...
                    <form action="visitorsByCourseShow.php" method="POST">
                        <fieldset>
					...
					try 
					{
						...
						$stmt = $conn->query("SELECT DISTINCT preferredCourse FROM visitorsinfo");
						?>
                                </div>
                                <div style="display: inline-table; width: 45%;">
                                    <select name="preferredCourse" class="input_box" style="width: 211px;" required="">
										...
										{ 							
											...
											<option value="<?php echo $preferredCourse;?>"><?php echo $preferredCourse;?></option>
										<?php
										}
									}
