...
<html>
    <head>
        ...
        <title>costSearchByItemShow.jsp</title>
    </head>
        ...
        <div class="main_body"> 
            ...
            <div style="margin:auto; width: 98%; min-height: 300px;">
                <div style="font-size:24px; text-align: center; font-weight: bold; margin-bottom: 10px;">
                    Cost Details of <?php echo $costTitle; ?>(From <?php echo $fromDate; ?> To <?php echo $fromDate; ?>) 
                </div>
                <table style="width:100%; text-align: center;">
					...
					try 
					{
						...
						$stmt = $conn->query("SELECT *FROM `costtable` WHERE costType = '$costTitle' AND entryDate BETWEEN  '$fromDate' AND 'toDate'");
			...
			$conn = null;
                 ...
                 <div style="height: 40px;">
                    <form action="costSearchByItemDatePrint.php">
