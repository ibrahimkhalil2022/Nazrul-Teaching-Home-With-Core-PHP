...
<html>
    ...
    <body style="background-color: darkorchid;">
		<div>
            ...
            <div style="display: inline-table;"><form action="costUnseen.php">
...
<!--                    <div class="dateSerial" style="text-align:left;">MR No.&nbsp;<b><?php echo $mrpNo?></b></div>-->
                    <div class="dateSerial" style="margin-left:280px; border-bottom: 1px solid black;">
                        <font style="font-weight: bolder; font-size: 20px;">Unseen Cost</font><br>
                    </div>
			...
			<table style="width:100%; text-align: center; margin-top:30px;">
                    ...
                    <?php 
						...
						try 
						{
							...
							$stmt = $conn->query('select *from costtable where status=1');
