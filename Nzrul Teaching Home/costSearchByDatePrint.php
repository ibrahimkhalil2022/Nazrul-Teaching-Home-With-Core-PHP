...
<html>
    ...
    <body style="background-color: darkorchid;">
		<div>
            ...
            <div style="display: inline-table;"><form action="costSearchByDateShow.php">
...
<!--                    <div class="dateSerial" style="text-align:left;">MR No.&nbsp;<b><?php echo $mrpNo?></b></div>-->
                    <div class="dateSerial" style="margin-left:280px; border-bottom: 1px solid black;">
                        <font style="font-weight: bolder; font-size: 20px;">Date wise Cost</font><br>
                    </div>
                ...
                <div style="text-align: center; margin:auto; font-size:12px;">
                    <b>Cost from:&nbsp;&nbsp;</b><?php echo $fromDate;?>&nbsp;&nbsp;<b>to&nbsp;&nbsp;</b> <?php echo $toDate;?>
                </div>
		...
		<table style="width:100%; text-align: center; margin-top:30px;">
					...
					try 
					{
						...
						$stmt = $conn->query("SELECT *FROM `costtable` WHERE entryDate BETWEEN  '$fromDate' AND 'toDate'");
