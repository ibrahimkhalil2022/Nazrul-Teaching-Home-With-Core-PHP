...
<html>
    <head>
        <script> 
            function showFields(string1)
            {
                ...
                xRequest1.open("get", "courseByBranchAjax.php?q=" + string1, "true");
                xRequest1.send();
            } 
        </script>
        <style>
        ...
        <title>CourseByBranch.jsp</title>
    </head>
	...
	<div style="height: 40px;">
    		<form action="courseByBranchPrint.php">
        		<input type="submit" value="Generate Report" style="float:right; margin-right:30px;">
    		</form>
	</div>
