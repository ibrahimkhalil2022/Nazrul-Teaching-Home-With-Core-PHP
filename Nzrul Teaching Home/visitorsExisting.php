    ...
    <body style="background-color: #f1f1f1">
        ...
        <div class="main_body">
            ...
            <div style="margin-top: 30px; margin-left: auto; margin-right: auto; width: 90%; min-height: 400px;">
                <div style="text-align:center; font-size: 25px; padding: 5px; margin-bottom: 20px;">Existing Visitor's</div>
                <table style="text-align:center;">
					...
					try 
					{
						...
						$stmt = $conn->query("SELECT *FROM visitorsexistingtable");
						...
						{ 
							...
							<tr>
								...
								<th>
									<div style="width:60px; font-size: 15px; padding: 3px; margin: auto; color: red;">
										 <a href="visitorsDeleteFinally.php?id=<?php echo $id; ?>" >Delete</a>
									</div>
								</th> 
							</tr>
