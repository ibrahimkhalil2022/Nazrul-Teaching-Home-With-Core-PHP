	...
	try 
		{
			...
			$id = $_SESSION["id"];
			$stmt = $conn->query("DELETE FROM `bookstocktable` WHERE id= '$id'");
...
<html>
	...
	<?php include 'header.php'; ?>
        <div class="main_body"> 
			...
			$sql = "SELECT * FROM bookstocktable where id = '$id'";
            ...
            <div class="adminform">
                <form action="#" method="POST">
                    ...
                    <input type="submit" name="delete" value="Update" style="margin-left: 389px; margin-bottom: 15px;margin-top: 10px;" class="input_box"/>
                </form>
            </div>
